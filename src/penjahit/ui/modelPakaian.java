...
public class modelPakaian extends javax.swing.JFrame {
    ...
    private void editbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editbtnActionPerformed
       ...
       try {
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/penjahit","root","");
            conn.createStatement().executeLargeUpdate("update model_pakaian set nama ='"+tnama.getText()+"',jenis_pakaian ='"+cbJP.getSelectedItem()+"',bahan_kain ='"+tbahan.getText()+"' where id_model ='"+tIDpesan.getText()+"'");
            tampilkan();
            //reset();
        } catch (SQLException ex) {
